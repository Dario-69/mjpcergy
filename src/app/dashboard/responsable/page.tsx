    ...
    <ProtectedRoute requiredRole="responsable">
      <div className="min-h-screen">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center py-4 sm:py-6 gap-4 sm:gap-0">
              <div className="animate-fade-in-left">
                ...
                <p className="text-sm sm:text-base text-gray-600 mt-1">Bonjour, <span className="font-semibold text-gray-800">{user?.name}</span></p>
              </div>
              <div className="flex flex-col sm:flex-row space-y-2 sm:space-y-0 sm:space-x-4 animate-fade-in-right w-full sm:w-auto">
                <Button variant="outline" size="sm" className="hover-lift transition-all-smooth w-full sm:w-auto">
                  <Settings className="h-4 w-4 mr-2" />
                  <span className="hidden sm:inline">Paramètres</span>
                  <span className="sm:hidden">⚙️</span>
                </Button>
                <Button size="sm" className="gradient-primary hover-glow transition-all-smooth w-full sm:w-auto">
        ...
        <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 mb-6 sm:mb-8">
            <Card className="hover-lift shadow-soft animate-fade-in-up" style={{ animationDelay: '0.1s' }}>
              <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                <CardTitle className="text-xs sm:text-sm font-medium text-gray-600">Total Membres</CardTitle>
                <div className="p-1.5 sm:p-2 rounded-lg bg-gradient-to-r from-blue-500 to-blue-600">
                  <Users className="h-3 w-3 sm:h-4 sm:w-4 text-white" />
                </div>
              </CardHeader>
              <CardContent className="pt-2">
                <div className="text-2xl sm:text-3xl font-bold text-gray-900">{stats?.overview?.totalUsers || 0}</div>
            ...
            <Card className="hover-lift shadow-soft animate-fade-in-up" style={{ animationDelay: '0.2s' }}>
              <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                <CardTitle className="text-xs sm:text-sm font-medium text-gray-600">Formations Actives</CardTitle>
                <div className="p-1.5 sm:p-2 rounded-lg bg-gradient-to-r from-green-500 to-green-600">
                  <BookOpen className="h-3 w-3 sm:h-4 sm:w-4 text-white" />
                </div>
              </CardHeader>
              <CardContent className="pt-2">
                <div className="text-2xl sm:text-3xl font-bold text-gray-900">{stats?.overview?.totalFormations || 0}</div>
                <p className="text-xs sm:text-sm text-gray-500 mt-1">
            ...
            <Card className="hover-lift shadow-soft animate-fade-in-up" style={{ animationDelay: '0.3s' }}>
              <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                <CardTitle className="text-xs sm:text-sm font-medium text-gray-600">Évaluations</CardTitle>
              ...
              <CardContent className="pt-2">
                <div className="text-2xl sm:text-3xl font-bold text-gray-900">{stats?.overview?.totalEvaluations || 0}</div>
                <p className="text-xs sm:text-sm text-gray-500 mt-1">
            ...
            <Card className="hover-lift shadow-soft animate-fade-in-up" style={{ animationDelay: '0.4s' }}>
              <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                <CardTitle className="text-xs sm:text-sm font-medium text-gray-600">Vidéos</CardTitle>
                <div className="p-1.5 sm:p-2 rounded-lg bg-gradient-to-r from-orange-500 to-orange-600">
                  <BookOpen className="h-3 w-3 sm:h-4 sm:w-4 text-white" />
                </div>
              </CardHeader>
              <CardContent className="pt-2">
                <div className="text-2xl sm:text-3xl font-bold text-gray-900">{stats?.overview?.totalVideos || 0}</div>
                <p className="text-xs sm:text-sm text-gray-500 mt-1">
                  Vidéos uploadées
                </p>
              </CardContent>
          ...
          {/* Activités récentes - Responsive */}
          {stats && (
            <Card className="mb-6 sm:mb-8 hover-lift shadow-medium animate-fade-in-up" style={{ animationDelay: '0.5s' }}>
              <CardHeader className="pb-4">
                <CardTitle className="text-lg sm:text-xl font-semibold bg-gradient-to-r from-gray-800 to-gray-600 bg-clip-text text-transparent">
              ...
              <CardContent className="pt-0">
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-6">
                  <div className="text-center p-3 sm:p-4 rounded-xl bg-gradient-to-br from-blue-50 to-blue-100 border border-blue-200">
                    <div className="text-2xl sm:text-3xl font-bold text-blue-600 mb-2">{stats.overview?.recentProgress || 0}</div>
                    <p className="text-xs sm:text-sm text-gray-600 font-medium">Progrès récents</p>
                  </div>
                  <div className="text-center p-3 sm:p-4 rounded-xl bg-gradient-to-br from-green-50 to-green-100 border border-green-200">
                    <div className="text-2xl sm:text-3xl font-bold text-green-600 mb-2">{stats.overview?.recentEvaluations || 0}</div>
                    <p className="text-xs sm:text-sm text-gray-600 font-medium">Évaluations terminées</p>
                  </div>
                  <div className="text-center p-3 sm:p-4 rounded-xl bg-gradient-to-br from-purple-50 to-purple-100 border border-purple-200">
                    <div className="text-2xl sm:text-3xl font-bold text-purple-600 mb-2">{stats.overview?.completedFormations || 0}</div>
                    <p className="text-xs sm:text-sm text-gray-600 font-medium">Formations complétées</p>
                  </div>
                </div>
              </CardContent>
            </Card>
